...
### 🌐 [Glompti — Full-Stack Social Media Platform](https://github.com/kabincs9/Glompti-Project)
> A complete social media web application with user authentication, posts, and multimedia sharing.
> Integrated backend logic, database management, and polished UI/UX frontend.

[![Demo](https://img.shields.io/badge/▶_Watch_Demo-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://youtu.be/MWLQjZugzGc)
[![Repo](https://img.shields.io/badge/View_Repo-181717?style=for-the-badge&logo=github)](https://github.com/kabincs9/Glompti-Project)
...
|---|---|---|
| [DNA](https://github.com/kabincs9/DNA) | 🧬 STR-based DNA sequence matcher | Python |
| [Speller](https://github.com/kabincs9/Speller) | 📖 Hash-table spell checker | C |
| [Finance](https://github.com/kabincs9/Finance) | 💰 Real-time stock trading simulator | Python/Flask |
| [Fiftyville](https://github.com/kabincs9/Fiftyville) | 🕵️ SQL forensic mystery | SQL |
| [IMDB](https://github.com/kabincs9/IMDB) | 🎥 Movie database query set | SQL |
